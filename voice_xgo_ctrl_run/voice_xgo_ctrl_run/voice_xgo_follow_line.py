...
import math
from voice_xgo_ctrl_run.follow_common import *
...
class LineDetect(Node):
	def __init__(self,name):
		...
		self.Mouse_XY = (0, 0)
		self.hsv_text = "/home/pi/cartographer_ws2/src/voice_xgo_ctrl_run/voice_xgo_ctrl_run/LineFollowHSV.text"
	...
	def execute(self, point_x, color_radius):
		if self.Joy_active == True:
			...
			return
		self.Start_state = True
		print("color_radius:", color_radius, "Joy_active:", self.Joy_active)
		if color_radius == 0: 
			print("Not Found")
