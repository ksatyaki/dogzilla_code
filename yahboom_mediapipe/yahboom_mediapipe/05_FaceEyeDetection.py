...
#import define msg
from yahboom_msgs.msg import PointArray
#import commom lib
import cv2 as cv
import numpy as np
import time
...
class FaceEyeDetection(Node):
    def __init__(self,name):
        ...
        self.eyeDetect = cv.CascadeClassifier( "/root/yahboomcar_ws/src/yahboom_mediapipe/yahboom_mediapipe/file/haarcascade_eye.xml")
        self.faceDetect = cv.CascadeClassifier(
"/root/yahboomcar_ws/src/yahboom_mediapipe/yahboom_mediapipe/file/haarcascade_eye.xml")
